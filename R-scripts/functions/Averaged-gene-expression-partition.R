...
averageCellsPartition <- function(expression.matrix, pseudocell.bin.df, branch.name){
  ...
  write.csv(pseudo.expr.data, paste0("outputs/pseudocell-RNA-", branch.name,".csv"))
